...
const testimonials = [
  ...
  },
  {
    ...
    location: 'Salem',
    rating: 5,
    text: "Running a restaurant means high AC and refrigeration loads. Frontline designed a 15kW system with battery backup for power cuts. During TANGEDCO outages, my business runs uninterrupted. Worth every rupee.",
    initials: 'AK',
    color: 'bg-ocean',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="test-header text-center mb-16">
          ...
          <h2 className="text-display-lg text-foreground">
            Trusted in <span className="text-gradient-solar">Karur & Tamil Nadu</span>
          </h2>
          <p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto">
            Real homes, real businesses, real savings. See what our customers say about
            going solar with Frontline.
          </p>

          <div className="mt-6 inline-flex items-center gap-3 px-5 py-3 rounded-full bg-solar/10 border border-solar/20" aria-label="Frontline Solar customer rating: 4.9 out of 5 from 1200 reviews">
            ...
            <span className="text-sm text-muted-foreground">from 1,200+ customers</span>
          </div>
        </div>

      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="why-header text-center mb-16">
          ...
          <p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto">
            We don't just sell solar. We engineer energy independence for Karur
            and Tamil Nadu homes, businesses, and farms — backed by Indian
            manufacturing and local expertise.
          </p>
        </div>
            ...
            {stats.map((stat, i) => {
              ...
              return (
                <div key={i} className="stat-item text-center">
                  ...
                  <p className="stat-value text-3xl md:text-4xl font-bold text-white tabular-nums">
                    {stat.value}
                  </p>
